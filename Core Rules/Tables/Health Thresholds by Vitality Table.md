# Health Thresholds by Vitality Table

**Wounded threshold:** half of maximum Vitality, rounded up. At or below this value, the character enters the **Wounded** condition and begins Bleeding Out.
...
*Thresholds for non-standard Vitality values: divide by 2 (Wounded) or 4 (Dying), then round up.*
