...
3. **Apothecary Opposition Check.** 
	...
	2. The apothecary's roll is based on the following:
		1. 1d10 base, plus any additional dice granted by Apothecary skills
		2. Flat bonuses from Apothecary skills (Apothecary I, II, and VI each grant +1)
		3. +2 for each Healer's Bag charge used
		4. +4 for each Master Healer's Satchel charge used
## Failure

1. If the healer fails the Apothecary Opposition Check, the character is not stabilized.
...
1. A character with Apothecary II or higher can perform a Forced Awakening on an Unconscious character using smelling salts or an equivalent stimulant.
2. The medic must be adjacent to the patient.
3. Forced Awakening costs 1 AP and requires no Apothecary Opposition Check.
